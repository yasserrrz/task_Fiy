...
export default function SingleTodo({todo , setTodos , todos , index , setCompleatedTodos}:Props) :React.ReactNode {
    ...
    <Draggable draggableId={todo.id.toString()} index={index}>

        {
            (provided)=>(
                ...
                <form className='todos_single' onSubmit={(e)=>{handelEdit(todo.id , e)}} {...provided.dragHandleProps} {...provided.draggableProps} ref={provided.innerRef }>
                {
                    edit? 
                    <>
