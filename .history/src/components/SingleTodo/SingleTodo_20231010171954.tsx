    ...
    <Draggable draggableId={todo.id.toString() } index={index}>

        {
            (provided , snapshot)=>(
                ...
                <form className={`todos ${snapshot.isDraggingOver  ? 'dragactive' : ""}`} onSubmit={(e)=>{handelEdit(todo.id , e)}} {...provided.draggableProps} {...provided.dragHandleProps}  ref={provided.innerRef }>
                {
                    edit? 
                    <>
