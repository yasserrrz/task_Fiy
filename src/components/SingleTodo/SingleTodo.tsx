    ...
    <Draggable draggableId={todo.id.toString() } index={index}>

        {
            (provided , snapshot)=>(
                ...
                <form className={`todos_single ${snapshot.isDragging  ? 'drag' : ""}`} onSubmit={(e)=>{handelEdit(todo.id , e)}} {...provided.draggableProps} {...provided.dragHandleProps}  ref={provided.innerRef }>
                {
                    edit? 
                    <>
